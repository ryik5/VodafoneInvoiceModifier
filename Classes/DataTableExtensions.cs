...
namespace MobileNumbersDetailizationReportGenerator
{
    public static class DataTableExtensions
    {
        ...
        public static DataTable EnableEditTable(this DataTable table)
        {
            DataTable result = table.Copy();
        ...
        /// </summary>
        /// <param name="pathToFile"></param>
        public static void ExportToExcelPivotTable(this DataTable source, string pathToFile, string nameSheet, string columnWithColor = null)
        {
            DataTable table = source;
            System.IO.FileInfo fileInfo = new System.IO.FileInfo(pathToFile);
